 ...
 * the dimension of observed features of users dimFeatureGeo: the dimension of
...
public class ParallelMRPJob extends AbstractJob {
	...
	public int run(String[] args) throws Exception {
		...
		/* create Fg */
		Job featureGeo = prepareJob(getFeatureGeoPath(), pathToFeatureGeo(),
				TextInputFormat.class, InputVectorsMapper.class,
				IntWritable.class, VectorWritable.class,
				VectorSumReducer.class, IntWritable.class,
				VectorWritable.class, SequenceFileOutputFormat.class);
		...
		/* create Fg' */
		Job featureGeoTranspose = prepareJob(pathToFeatureGeo(),
				pathToFeatureGeoTranspose(), TransposeMapper.class,
				IntWritable.class, VectorWritable.class,
				MergeVectorsReducer.class, IntWritable.class,
				VectorWritable.class);
		...
		Job averageGeoFeatureValue = prepareJob(pathToFeatureGeo(),
	...
	private Path getFeatureGeoPath() {
		return new Path(this.featureGeoPath);
	}

	private Path pathToFeatureGeo() {
		return getOutputPath("featureGeo");
	}

	private Path pathToFeatureGeoTranspose() {
		return getOutputPath("featureGeoTranspose");
	}
